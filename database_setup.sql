...
DELETE FROM "Submissions"
WHERE "Id" = '17232891-7f1b-4967-a0ef-b62e0b7cebaf';

DELETE FROM "Submissions"
WHERE "Id" = '7bbd1ef4-9432-4ea2-ab29-b6fda8e6ad11';

DELETE FROM "Submissions"
WHERE "Id" = 'a1ad2589-6f12-40a3-acc8-a51262255649';

DELETE FROM "Submissions"
WHERE "Id" = 'cd6c1df0-a612-4bac-ba86-6804a24a41fd';

DELETE FROM "TeacherAssignments"
WHERE "Id" = '047cbd26-036e-4dcf-b18a-26d1a3f0abb7';

DELETE FROM "TeacherAssignments"
WHERE "Id" = '11201fde-d423-4751-8d04-9bef0f11fda6';

DELETE FROM "TeacherAssignments"
WHERE "Id" = '2e4bbb50-289f-483d-8d3a-6abd7c88d69b';

DELETE FROM "TeacherAssignments"
WHERE "Id" = '5b33d480-6a78-477c-8b1c-e4ca2075f179';

DELETE FROM "TeacherAssignments"
WHERE "Id" = '77334f15-8913-4db3-871d-eb78ea87d4cb';

DELETE FROM "TeacherAssignments"
WHERE "Id" = 'da1816ed-a2cf-470e-8af2-6368bff30266';

UPDATE "Assignments" SET "CreatedAt" = TIMESTAMPTZ '2026-08-11T15:46:18.207536Z', "Deadline" = TIMESTAMPTZ '2026-08-21T15:46:18.207535Z', "UpdatedAt" = TIMESTAMPTZ '2026-08-11T15:46:18.207536Z'
WHERE "Id" = '40000000-0000-0000-0000-000000000001';

UPDATE "Assignments" SET "CreatedAt" = TIMESTAMPTZ '2026-08-09T15:46:18.207537Z', "Deadline" = TIMESTAMPTZ '2026-08-19T15:46:18.207537Z', "UpdatedAt" = TIMESTAMPTZ '2026-08-09T15:46:18.207538Z'
WHERE "Id" = '40000000-0000-0000-0000-000000000002';

UPDATE "Assignments" SET "CreatedAt" = TIMESTAMPTZ '2026-07-30T15:46:18.207539Z', "Deadline" = TIMESTAMPTZ '2026-08-12T15:46:18.207539Z', "UpdatedAt" = TIMESTAMPTZ '2026-07-30T15:46:18.207539Z'
WHERE "Id" = '40000000-0000-0000-0000-000000000003';

UPDATE "Assignments" SET "CreatedAt" = TIMESTAMPTZ '2026-08-13T15:46:18.20754Z', "Deadline" = TIMESTAMPTZ '2026-08-24T15:46:18.20754Z', "UpdatedAt" = TIMESTAMPTZ '2026-08-13T15:46:18.20754Z'
WHERE "Id" = '40000000-0000-0000-0000-000000000004';

UPDATE "Assignments" SET "CreatedAt" = TIMESTAMPTZ '2026-08-14T15:46:18.207542Z', "Deadline" = TIMESTAMPTZ '2026-08-28T15:46:18.207542Z', "UpdatedAt" = TIMESTAMPTZ '2026-08-14T15:46:18.207542Z'
WHERE "Id" = '40000000-0000-0000-0000-000000000005';

UPDATE "Classes" SET "CreatedAt" = TIMESTAMPTZ '2026-02-14T15:46:14.680574Z'
WHERE "Id" = '10000000-0000-0000-0000-000000000001';

UPDATE "Classes" SET "CreatedAt" = TIMESTAMPTZ '2026-02-14T15:46:14.680575Z'
WHERE "Id" = '10000000-0000-0000-0000-000000000002';

UPDATE "Classes" SET "CreatedAt" = TIMESTAMPTZ '2026-02-14T15:46:14.680578Z'
WHERE "Id" = '10000000-0000-0000-0000-000000000003';

UPDATE "Subjects" SET "CreatedAt" = TIMESTAMPTZ '2026-08-14T15:46:14.68061Z'
WHERE "Id" = '20000000-0000-0000-0000-000000000001';

UPDATE "Subjects" SET "CreatedAt" = TIMESTAMPTZ '2026-08-14T15:46:14.680611Z'
WHERE "Id" = '20000000-0000-0000-0000-000000000002';
...
UPDATE "Subjects" SET "CreatedAt" = TIMESTAMPTZ '2026-08-14T15:46:14.680612Z'
WHERE "Id" = '20000000-0000-0000-0000-000000000005';
...
INSERT INTO "Submissions" ("Id", "Answer", "AssignmentId", "Feedback", "Marks", "PdfUrl", "Status", "StudentId", "SubmittedAt", "UpdatedAt")
VALUES ('3530c972-b4fe-4db8-85df-61199f54ea8f', '1) x² - 5x + 6 = 0 → (x-2)(x-3) = 0 → x = 2 or x = 3
2) 2x² + 7x + 3 = 0 → x = (-7 ± √(49-24))/4 → x = -1/2 or x = -3
3) x² - 9 = 0 → (x-3)(x+3) = 0 → x = ±3', '40000000-0000-0000-0000-000000000001', 'Excellent work! All solutions are correct. Your use of factoring in problem 1 and 3 is efficient. In problem 2, consider showing the discriminant calculation more explicitly.', 88, NULL, 3, '30000000-0000-0000-0000-000000000004', TIMESTAMPTZ '2026-08-12T15:46:18.207558Z', TIMESTAMPTZ '2026-08-12T15:46:18.207559Z');
INSERT INTO "Submissions" ("Id", "Answer", "AssignmentId", "Feedback", "Marks", "PdfUrl", "Status", "StudentId", "SubmittedAt", "UpdatedAt")
VALUES ('45fde33b-090f-4401-bc26-65ebb72e5a92', '1) x = 2 or x = 3
2) x = -0.5 or x = -3
3) x = 3 or x = -3
(Solved using quadratic formula for all)', '40000000-0000-0000-0000-000000000001', NULL, NULL, NULL, 2, '30000000-0000-0000-0000-000000000005', TIMESTAMPTZ '2026-08-13T15:46:18.207561Z', TIMESTAMPTZ '2026-08-13T15:46:18.207561Z');
INSERT INTO "Submissions" ("Id", "Answer", "AssignmentId", "Feedback", "Marks", "PdfUrl", "Status", "StudentId", "SubmittedAt", "UpdatedAt")
VALUES ('d891cff1-0590-43e2-bd8a-839356d3cad2', 'Technology has revolutionized education in countless ways. From interactive learning platforms to instant access to global resources, the benefits far outweigh the challenges. While critics point to screen time concerns and digital distractions, a structured approach to technology integration enables personalized learning, enhances collaboration, and prepares students for a digital workforce...', '40000000-0000-0000-0000-000000000002', NULL, NULL, NULL, 1, '30000000-0000-0000-0000-000000000004', TIMESTAMPTZ '2026-08-14T09:46:18.207562Z', TIMESTAMPTZ '2026-08-14T09:46:18.207562Z');
INSERT INTO "Submissions" ("Id", "Answer", "AssignmentId", "Feedback", "Marks", "PdfUrl", "Status", "StudentId", "SubmittedAt", "UpdatedAt")
VALUES ('f7773fd0-4043-4110-8146-9f2762c7203b', 'Newton''s First Law: An object at rest stays at rest... [detailed answers]', '40000000-0000-0000-0000-000000000003', 'Good understanding of the first two laws. Work on applying the third law in complex systems.', 72, NULL, 3, '30000000-0000-0000-0000-000000000004', TIMESTAMPTZ '2026-08-09T15:46:18.207564Z', TIMESTAMPTZ '2026-08-09T15:46:18.207564Z');

INSERT INTO "TeacherAssignments" ("Id", "ClassId", "CreatedAt", "SubjectId", "TeacherId")
VALUES ('28b3d2bc-4b70-4c1f-8d3e-f5180a54b96b', '10000000-0000-0000-0000-000000000002', TIMESTAMPTZ '2026-08-14T15:46:18.207511Z', '20000000-0000-0000-0000-000000000004', '30000000-0000-0000-0000-000000000003');
INSERT INTO "TeacherAssignments" ("Id", "ClassId", "CreatedAt", "SubjectId", "TeacherId")
VALUES ('4c8db5c2-1b41-4f42-85cc-cdbcf23d2e27', '10000000-0000-0000-0000-000000000002', TIMESTAMPTZ '2026-08-14T15:46:18.207487Z', '20000000-0000-0000-0000-000000000006', '30000000-0000-0000-0000-000000000002');
INSERT INTO "TeacherAssignments" ("Id", "ClassId", "CreatedAt", "SubjectId", "TeacherId")
VALUES ('65da5580-27c5-415e-8f08-c94e732ba86e', '10000000-0000-0000-0000-000000000001', TIMESTAMPTZ '2026-08-14T15:46:18.20751Z', '20000000-0000-0000-0000-000000000007', '30000000-0000-0000-0000-000000000003');
INSERT INTO "TeacherAssignments" ("Id", "ClassId", "CreatedAt", "SubjectId", "TeacherId")
VALUES ('7073c50e-7080-4bbb-91ad-3d2c6efbe927', '10000000-0000-0000-0000-000000000003', TIMESTAMPTZ '2026-08-14T15:46:18.207485Z', '20000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000002');
INSERT INTO "TeacherAssignments" ("Id", "ClassId", "CreatedAt", "SubjectId", "TeacherId")
VALUES ('b55b7c53-6d4f-456a-88fd-95cf76778e4d', '10000000-0000-0000-0000-000000000003', TIMESTAMPTZ '2026-08-14T15:46:18.207508Z', '20000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000003');
INSERT INTO "TeacherAssignments" ("Id", "ClassId", "CreatedAt", "SubjectId", "TeacherId")
VALUES ('dc02e9a5-7042-4844-8aa7-3b17df20af24', '10000000-0000-0000-0000-000000000003', TIMESTAMPTZ '2026-08-14T15:46:18.207486Z', '20000000-0000-0000-0000-000000000003', '30000000-0000-0000-0000-000000000002');

UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2025-08-14T15:46:14.846501Z', "PasswordHash" = '$2a$11$5REohqOllGiuFkFsKa8D1.F5BcrlziMBWI4GL0VA5jEtO38eiQnj6', "UpdatedAt" = TIMESTAMPTZ '2025-08-14T15:46:14.846502Z'
WHERE "Id" = '30000000-0000-0000-0000-000000000001';

UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2025-10-14T15:46:15.007342Z', "PasswordHash" = '$2a$11$9ajSVm5oqU4Bg4iT/QStkeaGglO/Df6XFuWuhak6CNT9kuxfNnIjy', "UpdatedAt" = TIMESTAMPTZ '2025-10-14T15:46:15.007344Z'
WHERE "Id" = '30000000-0000-0000-0000-000000000002';

UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2025-12-14T15:46:15.205252Z', "PasswordHash" = '$2a$11$.zGwUqXxQkaQmyHg6Vye/.pX7RbHyFH7BlFT4T/Jb4St25.e8vYwa', "UpdatedAt" = TIMESTAMPTZ '2025-12-14T15:46:15.205256Z'
WHERE "Id" = '30000000-0000-0000-0000-000000000003';

UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2026-02-14T15:46:15.55825Z', "PasswordHash" = '$2a$11$2TtwiuNppviN5AK0G2DKUubf2wvdxK55DHGMTuM2uvYfZwJB9WZR6', "UpdatedAt" = TIMESTAMPTZ '2026-02-14T15:46:15.558251Z'
WHERE "Id" = '30000000-0000-0000-0000-000000000004';

UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2026-02-14T15:46:15.857424Z', "PasswordHash" = '$2a$11$WTJyW/sbtp5VYIuuikrgs.bR81d0RCLnu9Q13ys7ZQsoFeKpmNFS.', "UpdatedAt" = TIMESTAMPTZ '2026-02-14T15:46:15.857425Z'
WHERE "Id" = '30000000-0000-0000-0000-000000000005';

UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2026-03-14T15:46:16.195443Z', "PasswordHash" = '$2a$11$5KPrlSBbugrsSRjP6UNQVOssoClfeNySRLKDXj28VOOA.GHM2lBRy', "UpdatedAt" = TIMESTAMPTZ '2026-03-14T15:46:16.195445Z'
WHERE "Id" = '30000000-0000-0000-0000-000000000006';

UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2026-03-14T15:46:16.541728Z', "PasswordHash" = '$2a$11$4BD9ioRn6dOdA7KNKIndGu8TWJnZq8tn4HJJNLuLMNlgqU8cEUBhC', "UpdatedAt" = TIMESTAMPTZ '2026-03-14T15:46:16.54173Z'
WHERE "Id" = '30000000-0000-0000-0000-000000000007';

UPDATE "Users" SET "CreatedAt" = TIMESTAMPTZ '2026-04-14T15:46:16.872587Z', "PasswordHash" = '$2a$11$w9csFq.kDf5witgnu24LBO4R4uEega3TnUBxtucivPEw3wbAEKB7q', "UpdatedAt" = TIMESTAMPTZ '2026-04-14T15:46:16.872589Z'
WHERE "Id" = '30000000-0000-0000-0000-000000000008';

INSERT INTO "Users" ("Id", "ClassId", "CreatedAt", "Email", "FullName", "IsActive", "PasswordHash", "Phone", "Role", "UpdatedAt")
VALUES ('30000000-0000-0000-0000-000000000009', NULL, TIMESTAMPTZ '2026-05-14T15:46:17.229216Z', 'michael.brown@school.com', 'Michael Brown', TRUE, '$2a$11$DK5MZLjW2tjkR9Rk/lA13u6Hl5JhHqOeRfA1kSgXAs3pAYNlil4pO', '+1-555-0103', 1, TIMESTAMPTZ '2026-05-14T15:46:17.229218Z');
INSERT INTO "Users" ("Id", "ClassId", "CreatedAt", "Email", "FullName", "IsActive", "PasswordHash", "Phone", "Role", "UpdatedAt")
VALUES ('30000000-0000-0000-0000-000000000010', '10000000-0000-0000-0000-000000000003', TIMESTAMPTZ '2026-05-14T15:46:17.674861Z', 'sophia.wilson@school.com', 'Sophia Wilson', TRUE, '$2a$11$BORnNoAsRn1NvUcHAOyu5OKjIMda5//mJ7hMD2F/nOcs3mKA2zavC', '+1-555-0206', 2, TIMESTAMPTZ '2026-05-14T15:46:17.674864Z');
INSERT INTO "Users" ("Id", "ClassId", "CreatedAt", "Email", "FullName", "IsActive", "PasswordHash", "Phone", "Role", "UpdatedAt")
VALUES ('30000000-0000-0000-0000-000000000011', '10000000-0000-0000-0000-000000000002', TIMESTAMPTZ '2026-05-14T15:46:18.207267Z', 'james.taylor@school.com', 'James Taylor', TRUE, '$2a$11$lhk9qRgEvurpjoDmfVjS0OPg/jbljhAKQ/ywKmdO1QOK8/VFsDxsu', '+1-555-0207', 2, TIMESTAMPTZ '2026-05-14T15:46:18.207269Z');

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260814154619_AddMoreSeedUsers', '8.0.0');
